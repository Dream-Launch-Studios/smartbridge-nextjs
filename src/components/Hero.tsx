    ...
    >
      <motion.div className="space-y-6 sm:space-y-8">
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          Empowering Your Smart Technology
          <br />{" "}
          <div>
            with Seamless{" "}
            <span className="w-fit bg-gradient-to-br from-foreground pr-1 via-primary to-primary/10 bg-clip-text text-transparent">
              AI Connections
            </span>
          </div>
        ...
        <motion.p
          className="mx-auto max-w-[800px] text-base sm:text-lg text-muted-foreground px-4"
          variants={itemVariants}
        >
          SmartBridge API brings{" "}
          <span className="font-semibold text-foreground">intelligent </span>
          natural language processing to your{" "}
          <span className="font-semibold text-foreground">fingertips. </span>
          Simplify,{" "}
          <span className="font-semibold text-foreground">scale </span>, and{" "}
          <span className="font-semibold text-foreground">connect </span>
          your innovations with our cutting-edge AI platform.
        </motion.p>
        <motion.div
      ...
      <div className="bottom-[-10rem] md:bottom-[-29rem] left-[50%] z-[-1] absolute bg-gradient-to-t opacity-50 dark:opacity-100 from-primary/30 blur-[8em] rounded-xl transition-all translate-x-[-50%] duration-700 ease-out w-[10rem] md:w-[30rem] h-[20rem] md:h-[30rem] rotate-[54deg]"></div>
    </motion.section>
  );
}
