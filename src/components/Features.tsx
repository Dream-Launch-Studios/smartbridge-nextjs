  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-4xl font-bold flex flex-col items-center gap-2 text-center mb-16">
          Why Choose <br /> SmartBridge API?
          <span className="text-sm font-semibold text-gray-400">
            Turbocharge your coding All tools on deck.
          </span>
        </h2>
